...
export default function About() {
  ...
  return (
    <AboutContainer>
      ...
      <TextContainer>
        <Paragrafo>
          Me chamo Hércules, sou estudante de <Marked>Ciências da Computação</Marked>no<Marked> Instituto Federal de Sergipe - IFS</Marked>. Sou natural de <Marked>Sergipe</Marked> e tenho 21 anos. Estou me especializando na área do <Marked>desenvolvimento web</Marked> com o
